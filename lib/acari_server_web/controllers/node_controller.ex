defmodule AcariServerWeb.NodeController do
  ...
  def client_comment_del(
        %{assigns: %{current_user: %{is_admin: true}}} = conn,
        %{"id" => id, "redirect_to" => redirect_to}
      ) do
  ...
  def client_comment_del(conn, %{"id" => _id, "redirect_to" => redirect_to}) do
    conn
